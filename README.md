...
The app checks here for updates automatically and prompts you to install:

- **Stable** — normal releases. The default.
- **Beta / hotfix** — GitHub *prereleases*. Opt in via **Settings → App updates → Include beta &
  hotfix releases**. Ships fixes sooner; may be less stable.
